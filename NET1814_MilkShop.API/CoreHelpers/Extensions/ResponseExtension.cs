...
namespace NET1814_MilkShop.API.CoreHelpers.Extensions
{
    ...
    {
        public static IActionResult Result(ResponseModel responseModel) => responseModel.StatusCode switch
        {
            ...
            StatusCodes.Status500InternalServerError => new ObjectResult(responseModel) { StatusCode = StatusCodes.Status500InternalServerError },
