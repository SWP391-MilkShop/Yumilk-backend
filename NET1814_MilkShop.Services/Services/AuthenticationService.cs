...
public sealed class AuthenticationService : IAuthenticationService
{
    ...
    public async Task<ResponseModel> VerifyAccountAsync(string token)
    {
        ...
        if (expirationTime < DateTime.UtcNow) return new ResponseModel { Status = "Error", Message = "Hết hạn" };
    ...
    public async Task<ResponseModel> RefreshTokenAsync(string token)
    {
        ...
        if (userExisted == null) return new ResponseModel { Status = "Error", Message = "Không tồn tại người dùng" };
